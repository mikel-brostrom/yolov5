...
def run(
        ...
        config_strongsort=ROOT / 'track/strong_sort/configs/strong_sort.yaml',
...
def parse_opt():
    ...
    parser.add_argument('--strong-sort-weights', type=Path, default=WEIGHTS / 'mobilenetv2_x1_0_msmt17.pt')
